///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'KabupatenKota'
...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'KabupatenKota'.
	/// </summary>
	public class KabupatenKota : DBInteractionBase
	{
		#region Class Member Declarations
			private SqlBoolean		_published;
			private SqlDateTime		_createdDate, _modifiedDate;
			private SqlInt32		_ordering, _createdBy, _modifiedBy, _propinsiId, _propinsiIdOld, _id;
		...
		public bool IsExist()
		{
			...
			cmdToExecute.CommandText = "dbo.[KabupatenKota_IsExist]";
			...
			try
			{
				...
				cmdToExecute.Parameters.Add(new SqlParameter("@PropinsiId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, _propinsiId));
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'KabupatenKota_IsExist' reported the ErrorCode: " + _errorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("KabupatenKota::IsExist::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[KabupatenKota_Insert]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'KabupatenKota_Insert' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("KabupatenKota::Insert::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[KabupatenKota_Update]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'KabupatenKota_Update' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("KabupatenKota::Update::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		/// <summary>
		/// Purpose: Update method for updating one or more rows using the Foreign Key 'PropinsiId.
		/// This method will Update one or more existing rows in the database. It will reset the field 'PropinsiId' in
		/// all rows which have as value for this field the value as set in property 'PropinsiIdOld' to 
		/// the value as set in property 'PropinsiId'.
		/// </summary>
		/// <returns>True if succeeded, otherwise an Exception is thrown. </returns>
		/// <remarks>
		/// Properties needed for this method: 
		...
		/// </UL>
		/// </remarks>
		public bool UpdateAllWPropinsiIdLogic()
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[KabupatenKota_UpdateAllWPropinsiIdLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				cmdToExecute.Parameters.Add(new SqlParameter("@PropinsiId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, _propinsiId));
				cmdToExecute.Parameters.Add(new SqlParameter("@PropinsiIdOld", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, _propinsiIdOld));
				cmdToExecute.Parameters.Add(new SqlParameter("@ErrorCode", SqlDbType.Int, 4, ParameterDirection.Output, true, 10, 0, "", DataRowVersion.Proposed, _errorCode));
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'KabupatenKota_UpdateAllWPropinsiIdLogic' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("KabupatenKota::UpdateAllWPropinsiIdLogic::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[KabupatenKota_Delete]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'KabupatenKota_Delete' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("KabupatenKota::Delete::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		/// <summary>
		/// Purpose: Delete method for a foreign key. This method will Delete one or more rows from the database, based on the Foreign Key 'PropinsiId'
		/// </summary>
		...
		/// </UL>
		/// </remarks>
		public bool DeleteAllWPropinsiIdLogic()
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[KabupatenKota_DeleteAllWPropinsiIdLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'KabupatenKota_DeleteAllWPropinsiIdLogic' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("KabupatenKota::DeleteAllWPropinsiIdLogic::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[KabupatenKota_SelectOne]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("KabupatenKota");
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'KabupatenKota_SelectOne' reported the ErrorCode: " + _errorCode);
				}

				if(toReturn.Rows.Count > 0)
				{
					_id = (Int32)toReturn.Rows[0]["Id"];
					_propinsiId = (Int32)toReturn.Rows[0]["PropinsiId"];
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("KabupatenKota::SelectOne::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[KabupatenKota_SelectAll]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("KabupatenKota");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'KabupatenKota_SelectAll' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("KabupatenKota::SelectAll::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[KabupatenKota_SelectAllWPropinsiIdLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("KabupatenKota");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'KabupatenKota_SelectAllWPropinsiIdLogic' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("KabupatenKota::SelectAllWPropinsiIdLogic::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		/// <summary>
		/// Purpose: GetListWPropinsiIdLogic method. This method will Select all rows from the table where is active.
		...
		/// </UL>
		/// </remarks>
		public DataTable GetListWPropinsiIdLogic()
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[KabupatenKota_GetListWPropinsiIdLogic]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("KabupatenKota");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'KabupatenKota_GetListWPropinsiIdLogic' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("KabupatenKota::GetListWPropinsiIdLogic::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		public SqlInt32 PropinsiId
		{
			...
			set
			{
				SqlInt32 propinsiIdTmp = (SqlInt32)value;
				if(propinsiIdTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("PropinsiId", "PropinsiId can't be NULL");
				}
				_propinsiId = value;
			}
		}
		public SqlInt32 PropinsiIdOld
		{
			...
			set
			{
				SqlInt32 propinsiIdOldTmp = (SqlInt32)value;
				if(propinsiIdOldTmp.IsNull)
				{
					throw new ArgumentOutOfRangeException("PropinsiIdOld", "PropinsiIdOld can't be NULL");
				}
