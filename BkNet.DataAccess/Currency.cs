...
// Generated by LLBLGen v1.21.2003.712 Final on: 19 September 2006, 13:10:33
...
namespace BkNet.DataAccess
{
	...
	public class Currency : DBInteractionBase
	{
		#region Class Member Declarations
			...
			private SqlInt32		_createdBy, _updatedBy, _ordering, _id;
		...
		public bool IsExist()
		{
			...
			cmdToExecute.CommandText = "dbo.[Currency_IsExist]";
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'Currency_IsExist' reported the ErrorCode: " + _errorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("Currency::IsExist::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[Currency_Insert]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				cmdToExecute.Parameters.Add(new SqlParameter("@UpdatedDate", SqlDbType.DateTime, 8, ParameterDirection.Input, true, 23, 3, "", DataRowVersion.Proposed, _updatedDate));
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'Currency_Insert' reported the ErrorCode: " + _errorCode);
				}
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[Currency_Update]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'Currency_Update' reported the ErrorCode: " + _errorCode);
				}
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[Currency_Delete]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'Currency_Delete' reported the ErrorCode: " + _errorCode);
				}
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[Currency_SelectOne]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'Currency_SelectOne' reported the ErrorCode: " + _errorCode);
				}
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[Currency_SelectAll]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("Currency");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'Currency_SelectAll' reported the ErrorCode: " + _errorCode);
				}
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[Currency_GetList]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("Currency");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'Currency_GetList' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("Currency::GetList::Error occured.", ex);
			}
			finally
			{
				// Close connection.
