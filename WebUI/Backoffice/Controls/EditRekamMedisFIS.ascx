<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditRekamMedisFIS.ascx.cs" Inherits="Backoffice_Controls_EditRekamMedisFIS" %>
...
<table class="adminheading" width="100%">
    <tr>
		<th class="menudottedline">
		    Pencatatan Data Hasil Fisioterapi 
		</th>
	</tr>
	<tr>
		<th class="menudottedline">
