<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditKasirRJ.ascx.cs" Inherits="Backoffice_Controls_EditKasirRJ" %>
                ...
                <asp:GridView CssClass="DataGridList" ID="GV" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                <asp:Button ID="btnDetil" runat="server" CausesValidation="false" CommandName="Select" Text="Detil" OnClick="btnDetil_Click" />
                ...
                <table class="adminform" border="0" width="100%">
                    <tr class="trvalidation">
                        <td class="tdvalidation" colspan="3">
                            ...
                            <asp:Label ID="lblRJLayananId" runat="server" Text="lblRJLayananId" Visible="false"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td class="text">
