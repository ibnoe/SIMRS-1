<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditKasirHemo.ascx.cs" Inherits="Backoffice_Controls_EditKasirHemo" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlList" runat="server" Width="100%">
                ...
                <asp:GridView CssClass="DataGridList" ID="GV" runat="server"
                    AutoGenerateColumns="False" DataKeyNames="RJLayananId" OnRowEditing="GV_RowEditing" OnPageIndexChanging="GV_PageIndexChanging" OnSelectedIndexChanging="GV_SelectedIndexChanging" Width="100%" OnRowDeleting="GV_RowDeleting" OnSorting="GV_Sorting" ShowFooter="True" OnSelectedIndexChanged="GV_SelectedIndexChanged">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Kelompok Pemeriksaan" SortExpression="Kelompok">
                            <ItemStyle Width="150px" />
                            <ItemTemplate>
                                <asp:Label ID="lblgKelompokPemeriksaanNama" runat="server" Text='<%# Eval("KelompokPemeriksaanNama") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:Button ID="btnEdit" Visible='<%# Eval("StatusBayar").ToString() == "0" ? true:true  %>' runat="server" CausesValidation="false" CommandName="Edit" Text="Edit" />
                                <asp:Button ID="btnDelete" Visible='<%# Eval("StatusBayar").ToString() == "0" ? true:true  %>' OnClientClick="return confirm('Apakah anda yakin akan menghapus data ini ?');"  runat="server" CausesValidation="false" CommandName="Delete" Text="Hapus" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
                ...
                <table class="adminform" border="0" width="100%">
                    ...
                    <tr>
                        <td colspan="3">
                            ...
                            <asp:TextBox ID="txtRJLayananId" Visible="false" runat="server" Width="27px"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td class="text">
                        ...
                        <td class="separator">
                            :</td>
                        <td class="value">
                            <asp:DropDownList ID="cmbKelompokPemeriksaan" runat="server" OnSelectedIndexChanged="cmbKelompokPemeriksaan_SelectedIndexChanged" AutoPostBack="True">
                            </asp:DropDownList>
            ...
            <asp:Panel ID="pnlView" runat="server" Width="100%">
                <table class="adminform" border="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td class="separator"></td>
                        <td class="value">
                            <asp:Button ID="btnEditDetil" ToolTip="Edit" runat="server" Text="Edit" OnClick="btnEditDetil_Click" />
                            <asp:Button ID="btnDeleteDetil" OnClientClick="return confirm('Apakah anda yakin akan menghapus data ini ?');"  runat="server" Text="Hapus" OnClick="btnDeleteDetil_Click"/>
