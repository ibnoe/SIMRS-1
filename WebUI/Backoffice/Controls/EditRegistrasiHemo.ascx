<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditRegistrasiHemo.ascx.cs" Inherits="Backoffice_Controls_EditRegistrasiHemo" %>
                    ...
                    <table class="adminform" runat="server" id="tblPenjaminKeluarga" border="0" width="100%" visible="false">
                        ...
                        <tr>
                            ...
                            <td class="separator">
                                :</td>
                            <td class="value">
                                <asp:TextBox ID="txtKesatuanPenjamin" runat="server" MaxLength="50" Width="350px"></asp:TextBox></td>
                        </tr>
                        <tr>
                            <td class="text">
                                Alamat Kesatuan</td>
