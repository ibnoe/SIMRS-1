<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewKasirRI.ascx.cs" Inherits="Backoffice_Controls_ViewKasirRI" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlList" runat="server" Width="100%">
                <asp:GridView CssClass="DataGridList" ID="GV" runat="server"
                    AutoGenerateColumns="False" DataKeyNames="RILayananId" OnRowEditing="GV_RowEditing" OnPageIndexChanging="GV_PageIndexChanging" OnSelectedIndexChanging="GV_SelectedIndexChanging" Width="100%" OnRowDeleting="GV_RowDeleting" OnSorting="GV_Sorting" ShowFooter="True">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="TanggalTransaksi" SortExpression="TanggalTransaksi">
                            <ItemStyle Width="100px" />
                            <ItemTemplate>
                                <asp:Label ID="lblgTanggalTransaksi" runat="server" Text='<%# Eval("TanggalTransaksi").ToString() != "" ?  ((DateTime)Eval("TanggalTransaksi")).ToString("dd/MM/yyyy HH:mm") : "" %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <table class="adminform" border="0" width="100%">
                    ...
                    <tr>
                       ...
                       <td class="value">
                            ...
                            <asp:RequiredFieldValidator ID="RVJamTransaksi" runat="server" ControlToValidate="txtJamTransaksi">*</asp:RequiredFieldValidator>
