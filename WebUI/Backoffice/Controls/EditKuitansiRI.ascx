<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditKuitansiRI.ascx.cs" Inherits="Backoffice_Controls_EditKuitansiRI" %>
        ...
        <Columns>
            ...
            <asp:TemplateField>
                ...
                <ItemTemplate>
                    ...
                    <asp:Label Text='<%# GetlinkEdit(Eval("KuitansiId").ToString(),Eval("JenisKuitansiId").ToString()) %>' ID="linkEdit" runat="server"></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
