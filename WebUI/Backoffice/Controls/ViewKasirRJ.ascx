<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewKasirRJ.ascx.cs" Inherits="Backoffice_Controls_ViewKasirRJ" %>
        ...
        <ContentTemplate>
            <asp:Panel ID="pnlList" runat="server" Width="100%">
                ...
                <asp:GridView CssClass="DataGridList" ID="GV" runat="server"
                    AutoGenerateColumns="False" DataKeyNames="RJLayananId" Width="100%" OnSorting="GV_Sorting" ShowFooter="True" OnSelectedIndexChanged="GV_SelectedIndexChanged">
                    <Columns>
