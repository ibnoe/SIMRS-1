<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ViewRegistrasiRJ.ascx.cs" Inherits="Backoffice_Controls_ViewRegistrasiRJ" %>
...
<table id="Table2" border="0" class="adminform" width="100%">
    ...
    <tr>
        ...
        <td class="separator">
            :</td>
        <td class="value">
            <asp:Label ID="lblJamPraktek" runat="server"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="text">
