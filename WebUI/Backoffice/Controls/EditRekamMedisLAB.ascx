<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditRekamMedisLAB.ascx.cs" Inherits="Backoffice_Controls_EditRekamMedisLAB" %>
...
<table class="adminheading" width="100%">
    <tr>
		<th class="menudottedline">
		    Pencatatan Data Hasil Laboratorium 
		</th>
	</tr>
	<tr>
		<th class="menudottedline">
