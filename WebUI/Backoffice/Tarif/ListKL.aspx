<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="ListKL.aspx.cs" Inherits="Backoffice_Tarif_ListKL" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				Daftar Layanan & Tarif Kesehatan Lain(KUBT,Khelasi, Alergi dan Akupuntur)
			</th>
    ...
    <asp:Panel ID="pnlSearch" runat="server" CssClass="collapsePanel" Height="0"  Width="100%">
        <table id="TableSearch" class="adminform" cellspacing="0" cellpadding="0" align="right" border="0">
			<tr>
				<td>&nbsp;Kelompok Layanan:<asp:DropDownList ID="cmbKelompokLayanan" OnSelectedIndexChanged="OnSearch" AutoPostBack="true" runat="server">
                    </asp:DropDownList>
