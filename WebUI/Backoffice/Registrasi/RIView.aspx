<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="RIView.aspx.cs" Inherits="Backoffice_Registrasi_RIView" Title="Untitled Page" %>
    ...
    <ajaxToolkit:TabContainer ID="TabPasien" runat="server" ActiveTabIndex="1">
        ...
        <ajaxToolkit:TabPanel ID="TabRegistrasi" runat="server" HeaderText="">
            ...
            <ContentTemplate>
                ...
                <hr />
                <asp:Button ID="btnEditRegistrasiRI" runat="server" CssClass="button" OnClick="btnEditRegistrasiRI_Click"
