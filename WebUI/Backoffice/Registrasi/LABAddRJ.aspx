<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="LABAddRJ.aspx.cs" Inherits="Backoffice_Registrasi_LABAddRJ" Title="Untitled Page" %>
    ...
    <table class="adminheading" width="100%" id="Table3">
        <tr>
            <th class="menudottedline">
                <%= Resources.GetString("RS", "TitleRegistrasiAddLABRJ")%>
            </th>
...
<asp:Panel id="pnlSearchHeader" runat="server" Width="100%" CssClass="collapsePanelHeader"> 
            ...
            </asp:Panel> <asp:Panel id="pnlSearch" runat="server" Width="100%" CssClass="collapsePanel" Height="0"><TABLE id="tblpnlSearchPasien" class="adminform" runat="server"><TBODY><TR><TD><TABLE><TBODY><TR><TD style="WIDTH: 70px; TEXT-ALIGN: right">Nomor RM:</TD><TD style="WIDTH: 100px; TEXT-ALIGN: left"><asp:TextBox id="txtNoRMSearch" runat="server"></asp:TextBox></TD><TD style="WIDTH: 70px; TEXT-ALIGN: right">Nama Pasien:</TD><TD style="WIDTH: 100px; TEXT-ALIGN: left"><asp:TextBox id="txtNamaSearch" runat="server"></asp:TextBox></TD><TD style="TEXT-ALIGN: left">NRP:</TD><TD style="WIDTH: 100px; TEXT-ALIGN: left"><asp:TextBox id="txtNRPSearch" runat="server"></asp:TextBox></TD><TD style="TEXT-ALIGN: left"><asp:Button id="btnSearch" onclick="btnSearch_Click" runat="server" CausesValidation="False" Text="Cari"></asp:Button> </TD></TR></TBODY></TABLE></TD></TR><TR><TD><asp:GridView id="GridViewPasien" runat="server" Width="100%" CssClass="DataGridList" OnPageIndexChanging="GridViewPasien_PageIndexChanging" OnSelectedIndexChanged="GridViewPasien_SelectedIndexChanged" DataKeyNames="RawatJalanId" AutoGenerateColumns="False" AllowPaging="True">
                                <Columns>
