<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="LABAddRI.aspx.cs" Inherits="Backoffice_Registrasi_LABAddRI" Title="Untitled Page" %>
    ...
    <table class="adminheading" width="100%" id="Table3">
        <tr>
            <th class="menudottedline">
                <%= Resources.GetString("RS", "TitleRegistrasiAddLABRI")%>
            </th>
        ...
        <ContentTemplate>
            ...
            <asp:Panel ID="pnlSearch" runat="server" CssClass="collapsePanel" Height="0"  Width="100%">
                <table class="adminform"  runat="server" id="tblpnlSearchPasien">
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="GridViewPasien" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="RawatInapId" OnSelectedIndexChanged="GridViewPasien_SelectedIndexChanged" Width="100%" OnPageIndexChanging="GridViewPasien_PageIndexChanging" CssClass="DataGridList">
                                <Columns>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td valign="top">
                                        <asp:ListBox ID="lstPemeriksaan" runat="server" Height="200px" Width="300px"></asp:ListBox>
                                    </td>
                                    <td>
                                    ...
                                    <td valign="top">
                                        <asp:DropDownList ID="cmbKelompokPemeriksaan" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cmbKelompokPemeriksaan_SelectedIndexChanged" Width="200px" DataTextField="Nama" DataValueField="Id"></asp:DropDownList><br />
                                        <asp:ListBox ID="lstRefPemeriksaan" runat="server" Height="170px" Width="200px"></asp:ListBox>
                                    </td>
                                </tr>
                            </table>
