<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="HemoView.aspx.cs" Inherits="Backoffice_Registrasi_HemoView" Title="Untitled Page" %>
    ...
    <ajaxToolkit:TabContainer ID="TabPasien" runat="server" ActiveTabIndex="1">
        ...
        <ajaxToolkit:TabPanel ID="TabRegistrasi" runat="server" HeaderText="">
            ...
            <ContentTemplate>
                ...
                <asp:Button ID="btnEditRegistrasiHemo" runat="server" CssClass="button" OnClick="btnEditRegistrasiHemo_Click"
