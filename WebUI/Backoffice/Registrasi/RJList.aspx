<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="RJList.aspx.cs" Inherits="Backoffice_Registrasi_RJList" Title="Untitled Page" %>
    ...
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("RS", "TitleRegistrasiListRJ")%>
			</th>
                        ...
                        <td>
                            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:TextBox ID="txtHari" runat="server" Visible="False" Width="11px"></asp:TextBox>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                        </td>
                        <td align="left">
                            &nbsp; Poliklinik:</td>
                        <td>
                            <asp:DropDownList id="cmbPoliklinik" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cmbPoliklinik_SelectedIndexChanged"></asp:DropDownList></td>
                        <td>
                            &nbsp; Dokter:</td>
                        <td>
                            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                                <ContentTemplate>
                                    <asp:DropDownList id="cmbDokter" runat="server" AutoPostBack="True" OnSelectedIndexChanged="cmbDokter_SelectedIndexChanged">
                                    </asp:DropDownList>
                                </ContentTemplate>
                                <Triggers>
						        ...
						        <asp:datagrid id="DataGridList" runat="server" CssClass="DataGridList" OnItemCreated="PageItemCreated"
								    ...
								    <Columns>
									    ...
									    <asp:TemplateColumn SortExpression="PoliklinikNama" HeaderText="Poliklinik">
										    <ItemStyle Width="150px"></ItemStyle>
										    <ItemTemplate>
											    <asp:label ID="Label6" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PoliklinikNama") %>' >
											    </asp:label>
										    </ItemTemplate>
									    </asp:TemplateColumn>
									    <asp:TemplateColumn SortExpression="DokterNama" HeaderText="Dokter">
										    <ItemStyle Width="100px"></ItemStyle>
										    <ItemTemplate>
											    <asp:label ID="Label7" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.DokterNama") %>' >
											    </asp:label>
										    </ItemTemplate>
									    </asp:TemplateColumn>
									    <asp:TemplateColumn SortExpression="JamPraktek" HeaderText="Jam Praktek">
										    <ItemStyle Width="75px"></ItemStyle>
										    <ItemTemplate>
											    <asp:label Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.JamPraktek") %>' >
											    </asp:label>
										    </ItemTemplate>
									    </asp:TemplateColumn>
									    <asp:TemplateColumn SortExpression="NomorTunggu" HeaderText="Nomor Tunggu">
										    <ItemStyle Width="50px" HorizontalAlign="Center"></ItemStyle>
										    <ItemTemplate>
											    <asp:label ID="Label8" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.NomorTunggu") %>' >
											    </asp:label>
										    </ItemTemplate>
									    </asp:TemplateColumn>
