<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="HemoAddRI.aspx.cs" Inherits="Backoffice_Registrasi_HemoAddRI" Title="Untitled Page" %>
    ...
    <table class="adminheading" width="100%" id="Table3">
        <tr>
            <th class="menudottedline">
                <%= Resources.GetString("RS", "TitleRegistrasiAddHemoRI")%>
            </th>
...
<asp:AsyncPostBackTrigger ControlID="GridViewPasien" EventName="SelectedIndexChanged"></asp:AsyncPostBackTrigger>
    ...
    <asp:Panel ID="pnlRJHeader" runat="server" CssClass="collapsePanelHeader" Width="100%"> 
        <div style="padding:5px; cursor: pointer; vertical-align: middle;">
            ...
            <div style="float: left; margin-left:5px;">Data Kunjungan Hemodialisa<asp:TextBox ID="TextBox1" runat="server" Visible="False" Width="9px"></asp:TextBox></div>
