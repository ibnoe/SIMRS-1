<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="RADAddRI.aspx.cs" Inherits="Backoffice_Registrasi_RADAddRI" Title="Untitled Page" %>
    ...
    <table class="adminheading" width="100%" id="Table3">
        <tr>
            <th class="menudottedline">
                <%= Resources.GetString("RS", "TitleRegistrasiAddRADRI")%>
            </th>
