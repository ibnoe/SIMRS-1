<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="FISAddBaru.aspx.cs" Inherits="Backoffice_Registrasi_FISAddBaru" Title="Untitled Page" %>
        ...
        <table class="adminheading" width="100%" id="Table3">
            <tr>
	            <th class="menudottedline">
                    <%= Resources.GetString("RS", "TitleRegistrasiAddFIS")%>
	            </th>
