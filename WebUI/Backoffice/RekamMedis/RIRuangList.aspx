<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="RIRuangList.aspx.cs" Inherits="Backoffice_RekamMedis_RIRuangList" Title="Untitled Page" %>
    ...
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("RS", "TitleSeacrPasien")%>
			</th>
		</tr>
	</table>
                            ...
                            <asp:GridView ID="GridViewPasien" CssClass="DataGridList" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="RawatInapId" OnSelectedIndexChanged="GridViewPasien_SelectedIndexChanged" Width="100%" OnPageIndexChanging="GridViewPasien_PageIndexChanging">
                                <Columns>
                                    <asp:TemplateField HeaderText="Tanggal Masuk" SortExpression="TanggalMasuk">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton Width="100%" ID="lbTanggalMasuk" Text='<%# Eval("TanggalMasuk", "{0:dd MMMM yyyy HH:mm}") %>' runat="server" CommandName="Select" ></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
