<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="RJList.aspx.cs" Inherits="Backoffice_RekamMedis_RJList" Title="Untitled Page" %>
    ...
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("RS", "TitleSeacrPasien")%> Rawat Jalan
			</th>
		</tr>
	</table>
                    ...
                    <ContentTemplate>
                        <asp:Panel ID="pnlGridView" runat="server" Width="100%">
                            <asp:GridView ID="GridViewPasien" CssClass="DataGridList" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="RawatJalanId" OnSelectedIndexChanged="GridViewPasien_SelectedIndexChanged" Width="100%" OnPageIndexChanging="GridViewPasien_PageIndexChanging">
                                <Columns>
                                    <asp:TemplateField HeaderText="Tanggal Kunjungan" SortExpression="TanggalBerobat">
                                    ...
                                    <asp:TemplateField HeaderText="Poliklinik Tujuan" SortExpression="PoliklinikNama">
                                        <ItemStyle Width="120px" />
                                        <ItemTemplate>
                                            <asp:Label Width="100%" ID="lblPoliklinikNama" runat="server" Text='<%# Eval("PoliklinikNama") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Dokter" SortExpression="DokterNama">
                                        <ItemStyle Width="120px" />
                                        <ItemTemplate>
                                            <asp:Label Width="100%" ID="lblDokterNama" runat="server" Text='<%# Eval("DokterNama") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Tanggal Lahir/Umur">
                                        <ItemStyle Width="60px" />
                                        <ItemTemplate>
                                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("TanggalLahir", "{0:dd/MM/yyyy}") %>'></asp:Label>
                                            &nbsp;(<asp:Label ID="lblUmur" runat="server" Text='<%# Eval("Umur") %>'></asp:Label>)
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                                <EmptyDataTemplate>
