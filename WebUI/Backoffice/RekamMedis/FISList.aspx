<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="FISList.aspx.cs" Inherits="Backoffice_RekamMedis_FISList" Title="Untitled Page" %>
    ...
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("RS", "TitleSeacrPasien")%> Fisioterapi
			</th>
		</tr>
	</table>
