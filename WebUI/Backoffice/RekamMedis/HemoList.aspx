<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="HemoList.aspx.cs" Inherits="Backoffice_RekamMedis_HemoList" Title="Untitled Page" %>
    ...
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("RS", "TitleSeacrPasien")%> Hemodialisa
			</th>
		</tr>
	</table>
