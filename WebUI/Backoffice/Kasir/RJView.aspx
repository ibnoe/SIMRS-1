<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="RJView.aspx.cs" Inherits="Backoffice_Kasir_RJView" Title="Untitled Page" %>
<%@ Register Src="../Controls/HeaderRJ.ascx" TagName="HeaderRJ" TagPrefix="uc5" %>
<%@ Register Src="../Controls/EditKuitansiRJ.ascx" TagName="EditKuitansiRJ" TagPrefix="uc6" %>
<%@ Register Src="../Controls/EditKasirRJ.ascx" TagName="EditKasirRJ" TagPrefix="uc4" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <ajaxToolkit:TabContainer ID="TabPasien" runat="server" ActiveTabIndex="3">
        ...
        <ajaxToolkit:TabPanel ID="TabKasir" runat="server" HeaderText="">
            ...
            <ContentTemplate>
                <uc4:EditKasirRJ ID="UCEditKasirRJ" runat="server" />
            </ContentTemplate>
        </ajaxToolkit:TabPanel>
        <ajaxToolkit:TabPanel ID="TabKuitansi" runat="server" HeaderText="">
            ...
            <ContentTemplate>
                <uc6:EditKuitansiRJ ID="UCEditKuitansiRJ" runat="server" />
            </ContentTemplate>
        </ajaxToolkit:TabPanel>
