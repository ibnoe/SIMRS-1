<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditKuitansiRI.aspx.cs" Inherits="Backoffice_Kasir_EdiKuitansiRI"%>
                ...
                <table class="adminheading" border="0" width="100%">
                    <tr>
                        <th class="menudottedline">
                            <asp:Label ID="lblTitleEditForm" runat="server" Text="Edit Kuitansi Pembayaran Rawat Inap"></asp:Label>
                        </th>
                    </tr>
                </table>
                <div>
