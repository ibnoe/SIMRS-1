<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditKuitansiRJ.aspx.cs" Inherits="Backoffice_Kasir_EdiKuitansiRJ"%>
                ...
                <table class="adminheading" border="0" width="100%">
                    <tr>
                        <th class="menudottedline">
                            <asp:Label ID="lblTitleEditForm" runat="server" Text="Edit Kuitansi Pembayaran Rawat Jalan"></asp:Label>
                        </th>
                    </tr>
                </table>
                <div>
                    <asp:Label ID="lblError" runat="server" ForeColor="Red"></asp:Label>
                      ...
                      <asp:TextBox ID="txtJumlahBiaya" Visible="false" runat="server" Width="27px"></asp:TextBox>
                </div>
