<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintKuitansiRJ.aspx.cs" Inherits="Backoffice_Kasir_PrintKuitansiRJ"%>
                ...
                <table class="adminheading" border="0" width="100%">
                    <tr>
                        <th class="menudottedline">
                            <asp:Label ID="lblTitleEditForm" runat="server" Text="Pembayaran Rawat Jalan"></asp:Label>
                        </th>
                    </tr>
                </table>
                <div>
                    <asp:Label ID="lblError" runat="server" ForeColor="Red"></asp:Label>
                      ...
                      <asp:TextBox ID="txtRawatJalanId" Visible="false" runat="server" Width="27px"></asp:TextBox>
                      ...
                      <asp:TextBox ID="txtPoliklinikId" Visible="false" runat="server" Width="27px"></asp:TextBox>
                </div>
                <table class="adminform" border="0" width="100%">
                    ...
                    <tr>
                        <td colspan="3">
                            <asp:GridView CssClass="DataGridList" ID="GV" runat="server"
                                AutoGenerateColumns="False" DataKeyNames="RJLayananId" Width="100%" ShowFooter="True">
                                <Columns>
                                    <asp:TemplateField SortExpression="RJLayananId">
                                        <ItemStyle HorizontalAlign="Center" Width="20px" />
                                        <HeaderTemplate>
                                            <asp:CheckBox ID="cbxAll" Checked="true" OnCheckedChanged="cbxAll_CheckedChanged" AutoPostBack="true" runat="server" />
                                        </HeaderTemplate>
                                        <ItemTemplate>
                                            <asp:CheckBox ID="cbxRJLayananId" Checked="true" OnCheckedChanged="cbxRJLayananId_CheckedChanged" AutoPostBack="true" runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <tr>
                        ...
                        <td class="separator" style="width: 1px">
                            :</td>
                        <td class="value">
                            <asp:TextBox ID="txtUserName" runat="server" MaxLength="50" ReadOnly="True" Width="350px"></asp:TextBox>
                            <asp:TextBox ID="txtUserId" runat="server" MaxLength="50" ReadOnly="True" Width="50px" Visible="False"></asp:TextBox></td>
                    </tr>
                    <tr>
