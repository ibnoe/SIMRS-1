<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Backoffice_Groups_List" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<table class="adminheading" id="Table3">
	<tr>
		<th class="menudottedline">
			<%= Resources.GetString("","TitleListGroup") %>
		</th>
	...
	<tr>
		<td>
			<table id="Table2" width="100%" border="0">
				<tr>
					<td><asp:panel id="pnlNavigation" runat="server">
								...
								<tr>
									...
									<td align="right">
										<asp:DropDownList id="cmbFilterBy" runat="server">
											<asp:ListItem Value="GroupName">Nama Grup</asp:ListItem>
											<asp:ListItem Value="GroupDesc">Keterangan</asp:ListItem>
										</asp:DropDownList></td>
									<td align="right">
									...
									<td align="right">
										<asp:Button id="btnSearch" onclick="OnSearch" runat="server" Text="Filter" CssClass="button"></asp:Button></td>
								</tr>
							</table>
						</asp:panel></td>
				</tr>
				<tr>
					<td colspan="2"><asp:datagrid id="DataGridList" runat="server" CssClass="DataGridList" AllowSorting="True" AllowPaging="True"
							DataKeyField="GroupId" AutoGenerateColumns="False" OnPageIndexChanged="PageChanged" OnSortCommand="SortByColumn"
							...
							<Columns>
								...
								<asp:TemplateColumn SortExpression="GroupName" HeaderText="Nama Grup">
									<ItemTemplate>
										<asp:label ID="Label1" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.GroupName") %>' >
										</asp:label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn SortExpression="GroupDesc" HeaderText="Keterangan">
									<ItemTemplate>
										<asp:label ID="Label2" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.GroupDesc") %>' >
										</asp:label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="<div align=center>Action</div>">
									...
									<ItemTemplate>
										<table cellpadding="0" cellspacing="0" align="center" border="0">
											<tr>
												<%# GetLinkButton(DataBinder.Eval(Container, "DataItem.GroupId").ToString(),DataBinder.Eval(Container, "DataItem.GroupName").ToString(),DataGridList.CurrentPageIndex.ToString())%>
											</tr>
										</Table>
									</ItemTemplate>
								</asp:TemplateColumn>
