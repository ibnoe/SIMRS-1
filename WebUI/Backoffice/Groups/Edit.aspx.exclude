<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Backoffice_Groups_Edit" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<table class="adminheading" id="Table3">
	<tr>
		<th class="menudottedline">
			<%= Resources.GetString("","TitleEditGroup") %>
		</th>
...
<table class="adminform" id="Table1" border="0">
	...
	<tr>
		...
		<td>
            <asp:TreeView  ID="TVModulAccess" runat="server" BorderWidth="1px" OnTreeNodeCheckChanged="TVModulAccess_TreeNodeCheckChanged" ShowCheckBoxes="All" ShowLines="True" Width="100%">
            </asp:TreeView>
        </td>
	</tr>
</table>
