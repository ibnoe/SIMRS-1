<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Backoffice_Referensi_Status_List" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleListStatus") %>
			</th>
					...
					<tr>
						<td colspan="2"><asp:datagrid id="DataGridList" runat="server" CssClass="DataGridList" OnItemCreated="PageItemCreated"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="KelompokStatusNama" HeaderText="Kelompok">
										<ItemStyle Width="100px"></ItemStyle>
										<ItemTemplate>
											<asp:label ID="Label3" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.KelompokStatusNama") %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="JenisPembayaranNama" HeaderText="Jenis Pembayaran">
										<ItemStyle Width="100px"></ItemStyle>
										<ItemTemplate>
											<asp:label ID="Label5" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.JenisPembayaranNama") %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="Keterangan" HeaderText="Keterangan">
										<ItemTemplate>
											<asp:label ID="Label6" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Keterangan") %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
