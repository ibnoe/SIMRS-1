<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="Delete.aspx.cs" Inherits="Backoffice_Referensi_Status_Delete" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleDeleteStatus") %>
			</th>
	...
	<table class="adminform" id="Table1" border="0">
		...
		<tr>
			...
			<td>
				<asp:Label id="lblKelompokStatus" runat="server"></asp:Label></td>
		</tr>
		<tr>
			<td class="text">Jenis Pembayaran</td>
			<td>
				<asp:Label id="lblJenisPembayaran" runat="server"></asp:Label></td>
		</tr>
		<tr>
