<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Backoffice_Referensi_Status_Edit" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleEditStatus") %>
			</th>
	...
	<table class="adminform" id="Table1" border="0">
		...
		<tr>
			...
			<td>
                <asp:DropDownList ID="cmbKelompokStatus" runat="server">
                </asp:DropDownList></td>
		</tr>
		<tr>
			<td class="text">Jenis Pembayaran</td>
			<td>
                <asp:DropDownList ID="cmbJenisPembayaran" runat="server">
                </asp:DropDownList></td>
		</tr>
		<tr>
