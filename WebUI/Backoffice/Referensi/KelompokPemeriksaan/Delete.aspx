<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="Delete.aspx.cs" Inherits="Backoffice_Referensi_KelompokPemeriksaan_Delete" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<table class="adminheading" id="Table3">
	<tr>
		<th class="menudottedline">
			<%= Resources.GetString("Referensi","TitleDeleteKelompokPemeriksaan") %>
		</th>
...
<table class="adminform" id="Table1" border="0">
	...
	<tr>
		<td class="text">Nama<asp:TextBox id="txtId" runat="server" MaxLength="2" Width="8px" ReadOnly="True" Visible="False"></asp:TextBox></td>
		<td>
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="lblJenisPemeriksaan" runat="server"></asp:Label></td>
    </tr>
    <tr>
        <td class="text">
            Keterangan</td>
