<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Backoffice_Referensi_SatuanKerja_List" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleListSatuanKerja") %>
			</th>
				...
				<table id="Table2" width="100%" border="0">
									...
									<tr>
										...
										<td align="right">
											<asp:DropDownList id="cmbFilterBy" runat="server">
												<asp:ListItem Value="Kode">Kode</asp:ListItem>
												<asp:ListItem Value="NamaSatker">Nama</asp:ListItem>
					...
					<tr>
						<td colspan="2"><asp:datagrid id="DataGridList" runat="server" CssClass="DataGridList" OnItemCreated="PageItemCreated"
								OnSortCommand="SortByColumn" OnPageIndexChanged="PageChanged" AutoGenerateColumns="False" DataKeyField="IdSatuanKerja"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="Kode" HeaderText="Kode">
										...
										<ItemTemplate>
											<asp:label Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Kode") %>' ID="lblKode">
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="NamaSatker" HeaderText="Nama">
										<ItemStyle Width="220px"></ItemStyle>
										<ItemTemplate>
											<asp:label ID="Label1" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.NamaSatker") %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="Keterangan" HeaderText="Keterangan">
										<ItemTemplate>
											<asp:label ID="Label2" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Keterangan") %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn HeaderText="<div align=center>Action</div>">
										...
										<ItemTemplate>
											<%# GetLinkButton(DataBinder.Eval(Container, "DataItem.IdSatuanKerja").ToString(),DataBinder.Eval(Container, "DataItem.NamaSatker").ToString(),DataGridList.CurrentPageIndex.ToString())%>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
