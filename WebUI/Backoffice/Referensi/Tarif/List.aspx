<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Backoffice_Referensi_Tarif_List" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleListTarif") %>
			</th>
    ...
    <asp:Panel ID="pnlSearch" runat="server" CssClass="collapsePanel" Height="0"  Width="100%">
        <table id="TableSearch" class="adminform" cellspacing="0" cellpadding="0" align="right" border="0">
			<tr>
				<td>Jenis Tarif:<asp:DropDownList ID="cmbJenisLayanan" OnSelectedIndexChanged="OnSearch" AutoPostBack="true" runat="server">
                    </asp:DropDownList>
                    &nbsp;Poliklinik:<asp:DropDownList ID="cmbPoliklinik" OnSelectedIndexChanged="OnSearch" AutoPostBack="true" runat="server">
                    </asp:DropDownList>
                    &nbsp;Kelompok Tarif:<asp:DropDownList ID="cmbKelompokLayanan" OnSelectedIndexChanged="OnSearch" AutoPostBack="true" runat="server">
                    </asp:DropDownList>
                    &nbsp;Kelas:<asp:DropDownList ID="cmbKelas" OnSelectedIndexChanged="OnSearch" AutoPostBack="true" runat="server">
                    </asp:DropDownList>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
				            ...
				            <tr>
					            <td colspan="2"><asp:datagrid id="DataGridList" runat="server" CssClass="DataGridList" OnItemCreated="PageItemCreated"
							            ...
							            <Columns>
								            ...
								            <asp:TemplateColumn SortExpression="JenisLayananNama" HeaderText="Jenis Tarif">
									            <ItemStyle Width="100px"></ItemStyle>
									            <ItemTemplate>
										            <asp:label ID="Label1" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.JenisLayananNama") %>' >
										            </asp:label>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            <asp:TemplateColumn SortExpression="PoliklinikNama" HeaderText="Poliklinik">
									            <ItemStyle Width="100px"></ItemStyle>
									            <ItemTemplate>
										            <asp:label ID="Label1" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.PoliklinikNama") %>' >
										            </asp:label>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            <asp:TemplateColumn SortExpression="KelompokLayananNama" HeaderText="Kelompok">
									            <ItemStyle Width="100px"></ItemStyle>
									            <ItemTemplate>
										            <asp:label ID="Label3" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.KelompokLayananNama") %>' >
										            </asp:label>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            <asp:TemplateColumn SortExpression="LayananNama" HeaderText="Layanan">
									            <ItemStyle Width="250px"></ItemStyle>
									            <ItemTemplate>
										            <asp:label ID="lblLayananNama" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.LayananNama") %>' >
										            </asp:label>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            ...
								            <asp:TemplateColumn SortExpression="Tarif" HeaderText="Tarif">
									            <ItemStyle Width="50px"></ItemStyle>
									            <ItemTemplate>
										            <asp:label ID="lblTarif" Width="100%" runat="server" Text='<%# ((decimal)DataBinder.Eval(Container, "DataItem.Tarif")).ToString("N") %>' >
										            </asp:label>
									            </ItemTemplate>
								            </asp:TemplateColumn>
								            ...
								            <asp:TemplateColumn HeaderText="<div align=center>Action</div>">
									            ...
									            <ItemTemplate>
										            <%# GetLinkButton(DataBinder.Eval(Container, "DataItem.Id").ToString(),DataBinder.Eval(Container, "DataItem.LayananNama").ToString(),DataGridList.CurrentPageIndex.ToString())%>
									            </ItemTemplate>
								            </asp:TemplateColumn>
							            </Columns>
        ...
        <Triggers>
            <asp:AsyncPostBackTrigger ControlID="cmbJenisLayanan" EventName="SelectedIndexChanged" />
