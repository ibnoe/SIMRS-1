<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Backoffice_Referensi_Dokter_List" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<table class="adminheading" id="Table3">
	<tr>
        <th class="menudottedline">
			<%= Resources.GetString("Referensi","TitleListDokter") %>
		</th>
			...
			<table id="Table2" width="100%" border="0">
								...
								<tr>
									...
									<td align="right">
										<asp:DropDownList id="cmbFilterBy" runat="server">
											...
											<asp:ListItem Value="Spesialis">Spesialis</asp:ListItem>
										</asp:DropDownList></td>
									<td align="right">
				...
				<tr>
					<td colspan="2"><asp:datagrid id="DataGridList" runat="server" CssClass="DataGridList" OnItemCreated="PageItemCreated"
							OnSortCommand="SortByColumn" OnPageIndexChanged="PageChanged" AutoGenerateColumns="False" DataKeyField="DokterId"
							...
							<Columns>
								...
								<asp:TemplateColumn SortExpression="NRP" HeaderText="NRP">
									<ItemStyle Width="100px"></ItemStyle>
									<ItemTemplate>
										<asp:label ID="Label1" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.NRP") %>' >
										</asp:label>
									</ItemTemplate>
								</asp:TemplateColumn>
								...
								<asp:TemplateColumn SortExpression="SpesialisNama" HeaderText="Spesialis">
									<ItemStyle Width="220px"></ItemStyle>
									<ItemTemplate>
										<asp:label ID="Label3" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.SpesialisNama") %>' >
										</asp:label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn SortExpression="JenisKelamin" HeaderText="Jenis Kelamin">
									<ItemStyle Width="100px"></ItemStyle>
									<ItemTemplate>
										<asp:label ID="Label5" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.JenisKelamin").ToString()=="L" ? "Laki-laki":"Perempuan"  %>' >
										</asp:label>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="<div align=center>Action</div>">
									...
									<ItemTemplate>
										<%# GetLinkButton(DataBinder.Eval(Container, "DataItem.DokterId").ToString(),DataBinder.Eval(Container, "DataItem.Nama").ToString(),DataGridList.CurrentPageIndex.ToString())%>
									</ItemTemplate>
								</asp:TemplateColumn>
							</Columns>
