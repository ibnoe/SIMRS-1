<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="Delete.aspx.cs" Inherits="Backoffice_Referensi_TempatTidur_Delete" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleDeleteTempatTidur") %>
			</th>
	...
	<table class="adminform" id="Table1" border="0">
        ...
        <tr>
            <td class="text">
                Ruang<asp:TextBox id="txtTempatTidurId" runat="server" MaxLength="2" Width="8px" ReadOnly="True" Visible="False"></asp:TextBox></td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblNomorTempat" runat="server"></asp:Label></td>
        </tr>
        <tr>
            <td class="text">
                Keterangan</td>
