<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Backoffice_Referensi_Poliklinik_List" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleListPoliklinik") %>
			</th>
					...
					<tr>
						<td colspan="2"><asp:datagrid id="DataGridList" runat="server" CssClass="DataGridList" OnItemCreated="PageItemCreated"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="JenisPoliklinikNama" HeaderText="Jenis Poliklinik">
										<ItemStyle Width="100px"></ItemStyle>
										<ItemTemplate>
											<asp:label ID="Label1" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.JenisPoliklinikNama") %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="KelompokPoliklinikNama" HeaderText="Kelompok">
										<ItemStyle Width="100px"></ItemStyle>
										<ItemTemplate>
											<asp:label ID="Label3" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.KelompokPoliklinikNama") %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
