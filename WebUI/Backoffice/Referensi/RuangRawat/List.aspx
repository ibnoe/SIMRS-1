<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Backoffice_Referensi_RuangRawat_List" Title="Untitled Page" %>
						...
						<td colspan="2"><asp:datagrid id="DataGridList" runat="server" CssClass="DataGridList" OnItemCreated="PageItemCreated"
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="<div align=center>Action</div>">
										...
										<ItemTemplate>
											<%# GetLinkButton(DataBinder.Eval(Container, "DataItem.RuangRawatId").ToString(), DataBinder.Eval(Container, "DataItem.RuangNama").ToString(), DataBinder.Eval(Container, "DataItem.KelasNama").ToString(), DataGridList.CurrentPageIndex.ToString())%>
										</ItemTemplate>
									</asp:TemplateColumn>
								</Columns>
