<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Backoffice_Referensi_Propinsi_Edit" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleEditPropinsi") %>
			</th>
	...
	<table class="adminform" id="Table1" border="0">
		...
		<tr>
			...
			<td><input onkeypress="CheckInteger()" id="txtKode" style="WIDTH: 32px; HEIGHT: 22px; TEXT-ALIGN: left"
					type="text" maxlength="2" size="1" name="txtKode" runat="server" />&nbsp;
