<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="AddRawatJalan.aspx.cs" Inherits="Backoffice_Referensi_Layanan_AddRawatJalan" Title="Untitled Page" %>
    ...
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleAddLayanan") %>
			</th>
