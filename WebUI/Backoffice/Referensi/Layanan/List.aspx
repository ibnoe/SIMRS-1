<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Backoffice_Referensi_Layanan_List" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Panel ID="pnlSearch" runat="server" CssClass="collapsePanel" Height="0"  Width="100%">
        <table id="TableSearch" class="adminform" cellspacing="0" cellpadding="0" align="right" border="0">
			<tr>
				<td>Jenis Layanan:<asp:DropDownList ID="cmbJenisLayanan" OnSelectedIndexChanged="OnSearch" AutoPostBack="true" runat="server">
                    </asp:DropDownList>
				            ...
				            <tr>
					            <td colspan="2"><asp:datagrid id="DataGridList" runat="server" CssClass="DataGridList" OnItemCreated="PageItemCreated"
							            ...
							            <Columns>
								            ...
								            <asp:TemplateColumn SortExpression="RJ" HeaderText="Tarif Rawat Jalan">
									            <ItemStyle Width="50px"></ItemStyle>
									            <ItemTemplate>
