<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="Delete.aspx.cs" Inherits="Backoffice_Referensi_Layanan_Delete" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
	...
	<table class="adminform" id="Table1" border="0">
		...
		<tr>
			...
			<td>
				<asp:Label id="lblJenisLayanan" runat="server"></asp:Label></td>
		</tr>
		<tr>
			<td class="text">Poliklinik</td>
			<td>
				<asp:Label id="lblPoliklinik" runat="server"></asp:Label></td>
		</tr>
		<tr>
			<td class="text">Kelompok</td>
			<td>
				<asp:Label id="lblKelompokLayanan" runat="server"></asp:Label></td>
		</tr>
		<tr>
