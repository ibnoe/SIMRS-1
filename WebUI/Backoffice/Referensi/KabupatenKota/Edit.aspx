<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="Edit.aspx.cs" Inherits="Backoffice_Referensi_KabupatenKota_Edit" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleEditKabupatenKota") %>
			</th>
	...
	<table class="adminform" id="Table1" border="0">
		...
		<tr>
			...
			<td>
				<asp:DropDownList id="cmbPropinsi" OnSelectedIndexChanged="OnPropinsiChanged" AutoPostBack="True"
		...
		<tr>
			...
			<td><input onkeypress="CheckInteger()" id="txtKodeProp" style="WIDTH: 32px; HEIGHT: 22px; TEXT-ALIGN: left"
					...
					type="text" maxLength="2" size="1" name="txtKodeKab" runat="server">
				<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" ControlToValidate="txtKodeKab">*</asp:RequiredFieldValidator></td>
		</tr>
		<tr>
