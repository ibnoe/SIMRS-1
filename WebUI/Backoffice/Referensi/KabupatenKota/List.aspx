<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Backoffice_Referensi_KabupatenKota_List" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleListKabupatenKota") %>
			</th>
		...
		<tr>
			<td>
				<table id="Table2" width="100%" border="0">
					<tr>
						<td colspan="2" class="asetselector">Propinsi:
							<asp:DropDownList id="cmbPropinsi" OnSelectedIndexChanged="OnPropinsiChanged" runat="server" AutoPostBack="True"></asp:DropDownList></td>
					</tr>
					<tr>
						<td>
						...
						<td><asp:panel id="pnlSearch" runat="server">
								<table id="TableSearch" cellspacing="0" cellpadding="0" align="right" border="0">
									<tr>
										...
										<td align="right">
											<asp:Button id="btnSearch" onclick="OnSearch" runat="server" Text="Cari" CssClass="button"></asp:Button></td>
									</tr>
								</table>
							</asp:panel></td>
					</tr>
						...
						<td colspan="2"><asp:datagrid id="DataGridList" runat="server" CssClass="DataGridList" OnItemCreated="PageItemCreated"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="Nama" HeaderText="Nama">
										...
										<ItemTemplate>
											<asp:label ID="Label1" Width="100%" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.Nama") %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
