<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="Delete.aspx.cs" Inherits="Backoffice_Referensi_KabupatenKota_Delete" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleDeleteKabupatenKota") %>
			</th>
	...
	<table class="adminform" id="Table1" border="0">
		...
		<tr>
			...
			<td>
				<asp:Label id="lblNamaPropinsi" runat="server"></asp:Label></td>
		</tr>
		<tr>
			<td class="text">Kode
