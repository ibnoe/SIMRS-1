<%@ Page Language="C#" MasterPageFile="~/Backoffice/Backoffice.master" AutoEventWireup="true" CodeFile="List.aspx.cs" Inherits="Backoffice_Referensi_JadwalDokter_List" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:ScriptManager ID="ScriptManager1" runat="server" EnableScriptGlobalization="true" EnableScriptLocalization="true"></asp:ScriptManager>
    <table class="adminheading" id="Table3">
		<tr>
			<th class="menudottedline">
				<%= Resources.GetString("Referensi","TitleListJadwalDokter") %>
			</th>
                            ...
                            <asp:datagrid id="DataGridList" runat="server" CssClass="DataGridList" OnItemCreated="PageItemCreated"
								...
								<Columns>
									...
									<asp:TemplateColumn SortExpression="Senin" HeaderText="Senin">
										<ItemTemplate>
											<asp:label ID="lblSenin" Width="100%" runat="server" Text='<%# GetJamPraktekSenin(DataBinder.Eval(Container, "DataItem.DokterId").ToString(), DataBinder.Eval(Container, "DataItem.PoliklinikId").ToString(),DataBinder.Eval(Container, "DataItem.Senin").ToString(), DataGridList.CurrentPageIndex.ToString()) %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="Selasa" HeaderText="Selasa">
										<ItemTemplate>
											<asp:label ID="lblSenin" Width="100%" runat="server" Text='<%# GetJamPraktekSenin(DataBinder.Eval(Container, "DataItem.DokterId").ToString(), DataBinder.Eval(Container, "DataItem.PoliklinikId").ToString(),DataBinder.Eval(Container, "DataItem.Selasa").ToString(), DataGridList.CurrentPageIndex.ToString()) %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="Rabu" HeaderText="Rabu">
										<ItemTemplate>
											<asp:label ID="lblSenin" Width="100%" runat="server" Text='<%# GetJamPraktekSenin(DataBinder.Eval(Container, "DataItem.DokterId").ToString(), DataBinder.Eval(Container, "DataItem.PoliklinikId").ToString(),DataBinder.Eval(Container, "DataItem.Rabu").ToString(), DataGridList.CurrentPageIndex.ToString()) %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="Kamis" HeaderText="Kamis">
										<ItemTemplate>
											<asp:label ID="lblSenin" Width="100%" runat="server" Text='<%# GetJamPraktekSenin(DataBinder.Eval(Container, "DataItem.DokterId").ToString(), DataBinder.Eval(Container, "DataItem.PoliklinikId").ToString(),DataBinder.Eval(Container, "DataItem.Kamis").ToString(), DataGridList.CurrentPageIndex.ToString()) %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="Jumat" HeaderText="Jumat">
										<ItemTemplate>
											<asp:label ID="lblSenin" Width="100%" runat="server" Text='<%# GetJamPraktekSenin(DataBinder.Eval(Container, "DataItem.DokterId").ToString(), DataBinder.Eval(Container, "DataItem.PoliklinikId").ToString(),DataBinder.Eval(Container, "DataItem.Jumat").ToString(), DataGridList.CurrentPageIndex.ToString()) %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="Sabtu" HeaderText="Sabtu">
										<ItemTemplate>
											<asp:label ID="lblSenin" Width="100%" runat="server" Text='<%# GetJamPraktekSenin(DataBinder.Eval(Container, "DataItem.DokterId").ToString(), DataBinder.Eval(Container, "DataItem.PoliklinikId").ToString(),DataBinder.Eval(Container, "DataItem.Sabtu").ToString(), DataGridList.CurrentPageIndex.ToString()) %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn SortExpression="Minggu" HeaderText="Minggu">
										<ItemTemplate>
											<asp:label ID="lblSenin" Width="100%" runat="server" Text='<%# GetJamPraktekSenin(DataBinder.Eval(Container, "DataItem.DokterId").ToString(), DataBinder.Eval(Container, "DataItem.PoliklinikId").ToString(),DataBinder.Eval(Container, "DataItem.Minggu").ToString(), DataGridList.CurrentPageIndex.ToString()) %>' >
											</asp:label>
										</ItemTemplate>
									</asp:TemplateColumn>
