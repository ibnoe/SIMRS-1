...
function changeDynaListValue( obj, valuename, listname, source, key, orig_key, orig_val ) {

	document.getElementById(valuename).value = 	obj.options[obj.selectedIndex].text;
	var list = document.getElementById(listname);
...
function changeDynaValue( source, dest ) {
	document.getElementById(dest).value = source.options[source.selectedIndex].text;
}


function OnStatusKepemilikanChange(obj,objdisplay, objvalue){
	if(obj.options[obj.selectedIndex].value == '1'){
		document.getElementById(objdisplay).style.display = 'block';
	} else{
		document.getElementById(objdisplay).style.display = 'none';
	}
	document.getElementById(objvalue).value = obj.options[obj.selectedIndex].text;
}
