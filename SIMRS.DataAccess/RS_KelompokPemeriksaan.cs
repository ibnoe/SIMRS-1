///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'RS_KelompokPemeriksaan'
...
{
    /// <summary>
    /// Purpose: Data Access class for the table 'RS_KelompokPemeriksaan'.
    /// </summary>
    public class RS_KelompokPemeriksaan : DBInteractionBase
    {
        #region Class Member Declarations
        private SqlBoolean _published;
        private SqlDateTime _createdDate, _modifiedDate;
        private SqlInt32 _createdBy, _modifiedBy, _ordering, _id, _jenisPemeriksaanId;
        private SqlString _kode, _nama, _keterangan, _jenisPemeriksaan;
        #endregion
        ...
        public bool IsExist()
        {
            ...
            cmdToExecute.CommandText = "dbo.[RS_KelompokPemeriksaan_IsExist]";
            ...
            try
            {
                ...
                cmdToExecute.Parameters.Add(new SqlParameter("@JenisPemeriksaanId", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, _jenisPemeriksaanId));
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_KelompokPemeriksaan_IsExist' reported the ErrorCode: " + _errorCode);
                }
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("RS_KelompokPemeriksaan::IsExist::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_KelompokPemeriksaan_Insert]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_KelompokPemeriksaan_Insert' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_KelompokPemeriksaan::Insert::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_KelompokPemeriksaan_Update]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_KelompokPemeriksaan_Update' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_KelompokPemeriksaan::Update::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_KelompokPemeriksaan_Delete]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_KelompokPemeriksaan_Delete' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_KelompokPemeriksaan::Delete::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_KelompokPemeriksaan_SelectOne]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_KelompokPemeriksaan");
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_KelompokPemeriksaan_SelectOne' reported the ErrorCode: " + _errorCode);
                }

                if (toReturn.Rows.Count > 0)
                {
                    _id = (Int32)toReturn.Rows[0]["Id"];
                    _jenisPemeriksaanId = (Int32)toReturn.Rows[0]["JenisPemeriksaanId"];
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_KelompokPemeriksaan::SelectOne::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_KelompokPemeriksaan_SelectAll]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_KelompokPemeriksaan");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_KelompokPemeriksaan_SelectAll' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_KelompokPemeriksaan::SelectAll::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_KelompokPemeriksaan_SelectAll2]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_KelompokPemeriksaan_SelectAll2' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_KelompokPemeriksaan::SelectAll2::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_KelompokPemeriksaan_GetList]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_KelompokPemeriksaan");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_KelompokPemeriksaan_GetList' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_KelompokPemeriksaan::GetList::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        public DataTable GetListByJenisPemeriksaanId()
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_KelompokPemeriksaan_GetListByJenisPemeriksaanId]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_KelompokPemeriksaan");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_KelompokPemeriksaan_GetListByJenisPemeriksaanId' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_KelompokPemeriksaan::GetListByJenisPemeriksaanId::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        public SqlInt32 JenisPemeriksaanId
        {
            get
            {
                return _jenisPemeriksaanId;
            }
            set
            {
                _jenisPemeriksaanId = value;
            }
        }
        ...
        public SqlString JenisPemeriksaan
        {
            get
            {
                return _jenisPemeriksaan;
            }
            set
            {
                _jenisPemeriksaan = value;
            }
        }
