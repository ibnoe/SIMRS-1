///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'RS_Spesialis'
...
{
	/// <summary>
	/// Purpose: Data Access class for the table 'RS_Spesialis'.
	/// </summary>
	public class RS_Spesialis : DBInteractionBase
	{
		...
		public bool IsExist()
		{
			...
			cmdToExecute.CommandText = "dbo.[RS_Spesialis_IsExist]";
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'RS_Spesialis_IsExist' reported the ErrorCode: " + _errorCode);
				}
			...
			catch(Exception ex)
			{
				...
				throw new Exception("RS_Spesialis::IsExist::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[RS_Spesialis_Insert]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'RS_Spesialis_Insert' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("RS_Spesialis::Insert::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[RS_Spesialis_Update]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'RS_Spesialis_Update' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("RS_Spesialis::Update::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[RS_Spesialis_Delete]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'RS_Spesialis_Delete' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("RS_Spesialis::Delete::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[RS_Spesialis_SelectOne]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("RS_Spesialis");
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'RS_Spesialis_SelectOne' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("RS_Spesialis::SelectOne::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[RS_Spesialis_SelectAll]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("RS_Spesialis");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'RS_Spesialis_SelectAll' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("RS_Spesialis::SelectAll::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	cmdToExecute = new SqlCommand();
			cmdToExecute.CommandText = "dbo.[RS_Spesialis_GetList]";
			cmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable toReturn = new DataTable("RS_Spesialis");
			SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
			...
			try
			{
				...
				{
					// Throw error.
					throw new Exception("Stored Procedure 'RS_Spesialis_GetList' reported the ErrorCode: " + _errorCode);
				}
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("RS_Spesialis::GetList::Error occured.", ex);
			}
			finally
			{
				// Close connection.
