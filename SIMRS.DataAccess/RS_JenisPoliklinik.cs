///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'RS_JenisPoliklinik'
...
{
    /// <summary>
    /// Purpose: Data Access class for the table 'RS_JenisPoliklinik'.
    /// </summary>
    public class RS_JenisPoliklinik : DBInteractionBase
    {
        ...
        public bool IsExist()
        {
            ...
            cmdToExecute.CommandText = "dbo.[RS_JenisPoliklinik_IsExist]";
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPoliklinik_IsExist' reported the ErrorCode: " + _errorCode);
                }
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("RS_JenisPoliklinik::IsExist::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPoliklinik_Insert]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPoliklinik_Insert' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPoliklinik::Insert::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPoliklinik_Update]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPoliklinik_Update' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPoliklinik::Update::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPoliklinik_Delete]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPoliklinik_Delete' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPoliklinik::Delete::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPoliklinik_SelectOne]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_JenisPoliklinik");
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPoliklinik_SelectOne' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPoliklinik::SelectOne::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPoliklinik_SelectAll]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_JenisPoliklinik");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPoliklinik_SelectAll' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPoliklinik::SelectAll::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPoliklinik_GetList]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_JenisPoliklinik");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPoliklinik_GetList' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPoliklinik::GetList::Error occured.", ex);
            }
            finally
            {
                // Close connection.
