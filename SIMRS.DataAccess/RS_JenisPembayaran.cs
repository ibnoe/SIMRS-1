///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'RS_JenisPembayaran'
...
{
    /// <summary>
    /// Purpose: Data Access class for the table 'RS_JenisPembayaran'.
    /// </summary>
    public class RS_JenisPembayaran : DBInteractionBase
    {
        ...
        public bool IsExist()
        {
            ...
            cmdToExecute.CommandText = "dbo.[RS_JenisPembayaran_IsExist]";
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPembayaran_IsExist' reported the ErrorCode: " + _errorCode);
                }
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("RS_JenisPembayaran::IsExist::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPembayaran_Insert]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPembayaran_Insert' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPembayaran::Insert::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPembayaran_Update]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPembayaran_Update' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPembayaran::Update::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPembayaran_Delete]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPembayaran_Delete' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPembayaran::Delete::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPembayaran_SelectOne]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_JenisPembayaran");
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPembayaran_SelectOne' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPembayaran::SelectOne::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPembayaran_SelectAll]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_JenisPembayaran");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPembayaran_SelectAll' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPembayaran::SelectAll::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPembayaran_GetList]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_JenisPembayaran");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPembayaran_GetList' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPembayaran::GetList::Error occured.", ex);
            }
            finally
            {
                // Close connection.
