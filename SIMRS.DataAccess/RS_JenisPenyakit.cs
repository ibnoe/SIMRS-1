///////////////////////////////////////////////////////////////////////////
// Description: Data Access class for the table 'RS_JenisPenyakit'
...
{
    /// <summary>
    /// Purpose: Data Access class for the table 'RS_JenisPenyakit'.
    /// </summary>
    public class RS_JenisPenyakit : DBInteractionBase
    {
        ...
        private SqlString _golonganPenyakitId, _kode, _nama, _keterangan;
        #endregion
        ...
        public bool IsExist()
        {
            ...
            cmdToExecute.CommandText = "dbo.[RS_JenisPenyakit_IsExist]";
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPenyakit_IsExist' reported the ErrorCode: " + _errorCode);
                }
            ...
            catch (Exception ex)
            {
                ...
                throw new Exception("RS_JenisPenyakit::IsExist::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPenyakit_Insert]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            {
                cmdToExecute.Parameters.Add(new SqlParameter("@Id", SqlDbType.Int, 4, ParameterDirection.Input, false, 10, 0, "", DataRowVersion.Proposed, _id));
                cmdToExecute.Parameters.Add(new SqlParameter("@GolonganPenyakitId", SqlDbType.VarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, _golonganPenyakitId));
                cmdToExecute.Parameters.Add(new SqlParameter("@Kode", SqlDbType.VarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, _kode));
                cmdToExecute.Parameters.Add(new SqlParameter("@Nama", SqlDbType.VarChar, 50, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, _nama));
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPenyakit_Insert' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPenyakit::Insert::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPenyakit_Update]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPenyakit_Update' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPenyakit::Update::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPenyakit_Delete]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPenyakit_Delete' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPenyakit::Delete::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPenyakit_SelectOne]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_JenisPenyakit");
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPenyakit_SelectOne' reported the ErrorCode: " + _errorCode);
                }

                if (toReturn.Rows.Count > 0)
                {
                    _id = (Int32)toReturn.Rows[0]["Id"];
                    _golonganPenyakitId = (string)toReturn.Rows[0]["GolonganPenyakitId"];
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPenyakit::SelectOne::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPenyakit_SelectAll]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_JenisPenyakit");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPenyakit_SelectAll' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPenyakit::SelectAll::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        {
            SqlCommand cmdToExecute = new SqlCommand();
            cmdToExecute.CommandText = "dbo.[RS_JenisPenyakit_GetList]";
            cmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable toReturn = new DataTable("RS_JenisPenyakit");
            SqlDataAdapter adapter = new SqlDataAdapter(cmdToExecute);
            ...
            try
            {
                ...
                {
                    // Throw error.
                    throw new Exception("Stored Procedure 'RS_JenisPenyakit_GetList' reported the ErrorCode: " + _errorCode);
                }
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("RS_JenisPenyakit::GetList::Error occured.", ex);
            }
            finally
            {
                // Close connection.
        ...
        public SqlString GolonganPenyakitId
        {
            get
            {
                return _golonganPenyakitId;
            }
            set
            {
                SqlString golonganPenyakitIdTmp = (SqlString)value;
                if (golonganPenyakitIdTmp.IsNull)
                {
                    throw new ArgumentOutOfRangeException("GolonganPenyakitId", "GolonganPenyakitId can't be NULL");
                }
                _golonganPenyakitId = value;
            }
        }
